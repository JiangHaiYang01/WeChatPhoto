...
public class LargerImageView extends AppCompatImageView {
    ...
    public LargerImageView(Context context, AttributeSet attr) {
        this(context, attr, 0);
    }

    public LargerImageView(Context context, AttributeSet attr, int defStyle) {
